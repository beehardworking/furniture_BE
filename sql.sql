...
--
-- Host: 127.0.0.1    Database: funiture
-- ------------------------------------------------------
...
CREATE TABLE `manufacturers` (
  `id` int NOT NULL AUTO_INCREMENT,
  `manufacturerName` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `users` (
  ...
  `role` int DEFAULT '1',
  `encryptedPassword` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2024-04-14 18:47:10
